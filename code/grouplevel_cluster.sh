...
PATH_REGRESSORS=${HOME}/projects/critchley_depersonalisation/code/group_design/groupmean_contrast.tsv
PATH_CONTRAST=${HOME}/projects/critchley_depersonalisation/code/group_design/groupmean_regressors.tsv
