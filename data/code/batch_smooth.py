...
def smoothing_skullstrip(bids_dir, output_dir, work_dir, subject_list, run, fwhm=6.0, name='smoothing_skullstrip'):
    ...
    sinker.inputs.substitutions = [('_run_1_subject_', 'sub-'),
                                   ('_skip0', 'func'),
    ...
    mask_results = pe.MapNode(ApplyMask(), name='mask_results', iterfield=['in_file', 'mask_file'])
    ...
    workflow.connect([
        (bg, susan, [('bolds', 'inputnode.in_files'),
